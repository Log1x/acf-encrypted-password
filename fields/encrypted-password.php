...
if (!class_exists('EncryptedPassword')) {
    class EncryptedPassword extends \acf_field
    {
    	...
    	public function input_admin_enqueue_scripts()
        {
    		...
    		wp_register_script('acf-input-encrypted-password', "{$url}assets/js/input.js", ['acf-input'], $version);
    		wp_enqueue_script('acf-input-encrypted-password');

    		wp_register_style('acf-input-encrypted-password', "{$url}assets/css/input.css", ['acf-input'], $version);
    		wp_enqueue_style('acf-input-encrypted-password');
    	}
